...
class TColumn extends TColumnBase {
  ...
  TColumn copyWith({
    ...
    return TColumn(
      ...
      useBarcodeCheckDigit:
          useBarcodeCheckDigit ?? this.useBarcodeCheckDigit,
      ...
      useUserDefineQRData:
          useUserDefineQRData ?? this.useUserDefineQRData,
      ...
      userDefineBarcodeText:
          userDefineBarcodeText ?? this.userDefineBarcodeText,
