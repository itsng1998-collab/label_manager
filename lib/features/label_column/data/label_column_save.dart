...
SELECT
  CASE WHEN OBJECT_ID('BM_RICH_COLUMN', 'U') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_COLUMN_ID') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_LABELSIZE_ID') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_COLUMN_ORDER') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_KEYWORD') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_COLUMN_NAME') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_TYPE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_WIDTH') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_HEIGHT') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_BARCODE_TYPE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_USE_BARCODE_CHECKDIGIT') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_SHOW_BARCODE_NUM') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_SHOW_QRCODE_TEXT') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_QRTEXT_ALIGNMENT') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_USE_USER_DEFINE_QRDATA') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_USER_DEFINE_QRDATA') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_USER_DEFINE_QRTEXT') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_PIXELSIZE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_TITLE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_VISIBLE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_QRCODE_CREATE_TYPE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_NATRIUM_JOIN_STRING') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_QRTEXT_FONTSIZE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_QRTEXT_FONTNAME') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_QRCODE_SCALE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_TIMEBARCODE_TYPE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_AUTO_INC') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_AUTO_INC_SIZE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_AUTO_INC_RANGE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_AUTO_INC_SAVE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_SEARCH_PRINT') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_USER_DEFINE_BARCODE_TEXT') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_AUTO_INC_ZERODEL') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_BARCODE_LINE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_BARCODE_LINE_SIZE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_BARCODE_ROTATE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_AUTO_INC_UPDATE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_USE_DATERANGE') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COLUMN', 'RICH_DATERANGE') IS NOT NULL
    AND OBJECT_ID('BM_RICH_CHECK_COLUMNS', 'U') IS NOT NULL
    AND COL_LENGTH('BM_RICH_CHECK_COLUMNS', 'RICH_CHECK_YN') IS NOT NULL
    AND OBJECT_ID('BM_RICH_COL_MIN', 'U') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COL_MIN', 'RICH_MIN_CHECK') IS NOT NULL
    AND OBJECT_ID('BM_RICH_ITEM', 'U') IS NOT NULL
    AND COL_LENGTH('BM_RICH_ITEM', 'RICH_ITEM_ID') IS NOT NULL
    AND COL_LENGTH('BM_RICH_ITEM', 'RICH_LABELSIZE_ID') IS NOT NULL
    AND OBJECT_ID('BM_RICH_COL_CONTENT', 'U') IS NOT NULL
    AND COL_LENGTH('BM_RICH_COL_CONTENT', 'RICH_COL_CONTENT_DATA') IS NOT NULL
    AND OBJECT_ID('BM_GS1_COLUMN_INFO', 'U') IS NOT NULL
    AND COL_LENGTH('BM_GS1_COLUMN_INFO', 'COLUMN_GS1_CODE') IS NOT NULL
    AND OBJECT_ID('BM_GS1_CONTAIN_COLUMN', 'U') IS NOT NULL
    AND COL_LENGTH('BM_GS1_CONTAIN_COLUMN', 'MAIN_COLUMN_ID') IS NOT NULL
    AND COL_LENGTH('BM_GS1_CONTAIN_COLUMN', 'CONTAIN_COLUMN_ID') IS NOT NULL
    THEN 1 ELSE 0 END AS HAS_CORE_SCHEMA,
  CASE WHEN COL_LENGTH('BM_RICH_COLUMN', 'RICH_USE_MISSING_KEYWORD_CHECK')
    IS NULL THEN 0 ELSE 1 END AS HAS_MAIN_MISSING_KEYWORD_CHECK,
  CASE WHEN COL_LENGTH('BM_RICH_COL_CONTENT', 'RICH_EDITABLE')
    IS NULL THEN 0 ELSE 1 END AS HAS_CONTENT_EDITABLE,
  CASE WHEN OBJECT_ID('BM_UPDATE_ITEM', 'U') IS NOT NULL
    AND OBJECT_ID('BM_UPDATE_COL_CONTENT', 'U') IS NOT NULL
    AND COL_LENGTH('BM_UPDATE_ITEM', 'RICH_UPDATE_ITEM_ID') IS NOT NULL
    AND COL_LENGTH('BM_UPDATE_ITEM', 'RICH_LABELSIZE_ID') IS NOT NULL
    AND COL_LENGTH('BM_UPDATE_COL_CONTENT', 'RICH_COLUMN_ID') IS NOT NULL
    AND COL_LENGTH('BM_UPDATE_COL_CONTENT', 'RICH_UPDATE_ITEM_ID') IS NOT NULL
    AND COL_LENGTH('BM_UPDATE_COL_CONTENT', 'RICH_COL_CONTENT_DATA') IS NOT NULL
    THEN 1 ELSE 0 END AS HAS_UPDATE_CONTENT,
  CASE WHEN OBJECT_ID('BM_RICH_STATUS_DATA', 'U')
    IS NOT NULL
    AND COL_LENGTH('BM_RICH_STATUS_DATA', 'RICH_COLUMN_ID') IS NOT NULL
    AND COL_LENGTH('BM_RICH_STATUS_DATA', 'RICH_COLID_CHANGE_DELETE_DATE') IS NOT NULL
...
DECLARE @OriginalColumns TABLE (
  ...
  COLUMN_GS1_FORMAT_OPTION INT, COLUMN_SHOW_GS1CODE BIT
);
...
DECLARE @OriginalContainValues TABLE (
  RICH_COLUMN_ID INT NOT NULL, CONTAIN_COLUMN_ID INT NOT NULL
);
INSERT @OriginalContainValues(RICH_COLUMN_ID, CONTAIN_COLUMN_ID)
SELECT DISTINCT
  C.value('@columnId', 'INT'),
  CONVERT(INT, V.value('string((text())[1])', 'NVARCHAR(100)'))
FROM @CommandDocument.nodes('/command/originalColumns/column') X(C)
...
IF EXISTS (
  SELECT G.MAIN_COLUMN_ID, G.CONTAIN_COLUMN_ID
  FROM BM_GS1_CONTAIN_COLUMN G
  JOIN BM_RICH_COLUMN C ON C.RICH_COLUMN_ID=G.MAIN_COLUMN_ID
  WHERE C.RICH_LABELSIZE_ID=@LabelSizeId
  EXCEPT
  SELECT RICH_COLUMN_ID, CONTAIN_COLUMN_ID FROM @OriginalContainValues
)
  THROW 51115, 'Label column auxiliary values changed after editing started.', 1;
