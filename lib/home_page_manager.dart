        ...
        if (backend.usesCanvasCapture) {
          ...
          if (driverPage != null) {
            debugLog(
              ...
              'quantizeMode=connectedCoverageGrowth '
              'coreLuminanceThreshold=$labelSheetWindowsDriverCoreLuminanceThreshold '
              'coverageInk=${driverPage.coverageInkEquivalent.toStringAsFixed(2)} '
              'targetInk=${driverPage.targetInkPixels} '
              'coreInk=${driverPage.coreInkPixels} '
              'connectedEdgeInk=${driverPage.partialCoverageInkPixels} '
              'rejectedEdge=${driverPage.rejectedEdgePixels} '
              'targetShortfall=${driverPage.targetInkShortfall} '
