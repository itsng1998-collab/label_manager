...
const bool itemElementLayoutDebugEnabled = false;
        ...
        final windowsCapture = backend == LabelPrintBackend.windowsDriver
          ...
          if (driverPage != null) {
            debugLog(
              ...
              'gray=${driverPage.antialiasPixels}/${driverPage.totalPixels} '
              'grayPercent=${driverPage.antialiasPercent.toStringAsFixed(2)} '
              'nonWhite=${driverPage.nonWhitePixels}/${driverPage.totalPixels} '
              'white=${driverPage.totalPixels - driverPage.nonWhitePixels} '
              'rasterInput=${driverPage.inputWidth}x${driverPage.inputHeight} '
              'rasterMapping=${driverPage.rasterMapping} '
              'toneMode=driverMonochrome '
...
double _itemPreviewVerticalTextOffset(
  String verticalAlign,
  double rectHeight,
  double textHeight,
) {
  final freeHeight = max(0.0, rectHeight - textHeight);
...
bool _itemCellMergeLayoutEquals(
  fs.FortuneCellMerge? left,
  fs.FortuneCellMerge? right,
) {
