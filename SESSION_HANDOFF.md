...
- stage/commit 예정(2026-07-08): 포함 파일은 `lib/page_home/preview_floating_window.dart`, `test/label_sheet_toolbar_test.dart`, `SESSION_HANDOFF.md`. unrelated dirty `lib/core/app.dart`, `lib/page_login/startup_dialog.dart`, `pubspec.lock`, `third_party/fortune_sheet/pubspec.lock`, `third_party/mssql_connection/pubspec.lock`는 제외한다.
