...
- 진행 중: [doc/app_menu_porting.txt] 전체 구현. Phase 0·1 기반, Phase 2 전체, Phase 3 관리 메뉴, 5.1.8 종료, 5.2.1 검색 및 치환과 5.3.1~5.3.3을 구현·검증·커밋했다. 5.2.2~5.2.6은 Phase 2에서 완료됐고 5.3.4는 `legacyUnreachable` 제외이며 다음은 5.3.5 `전자저울 관리`다.
