...
- stage/commit 예정(2026-07-08): 기능 커밋 대상은 `lib/home_page_manager.dart`, `test/label_sheet_toolbar_test.dart`, `SESSION_HANDOFF.md`. unrelated dirty `lib/core/app.dart`는 제외한다. 기능 커밋 확정 후 해시 기록용 인수인계 커밋을 별도로 남긴다.
